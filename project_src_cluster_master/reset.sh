...
#master only
sudo sed -i -e "s/.*ip-172-31-12-132/$master ip-172-31-12-132/" /etc/hosts
sudo sed -i -e "s/.*ip-172-31-9-108/$worker1 ip-172-31-9-108/" /etc/hosts
sudo sed -i -e "s/.*ip-172-31-9-245/$worker2 ip-172-31-9-245/" /etc/hosts
